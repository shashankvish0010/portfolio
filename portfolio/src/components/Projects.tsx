            ...
            <div className='flex md:flex-row flex-col md:items-center justify-center gap-5 p-3 w-[90%]'>
                <div className='flex flex-col gap-5 md:w-[65%] w-[100%]'>
                    ...
                    <div className='h-max w-max flex gap-3'>
                        <span onClick={() => window.location.href = props.projectUrl} className='cursor-pointer header_list h-max w-max flex flex-row items-center gap-2 bg-indigo-600 text-white p-2 rounded'>
                            <p>Live Preview</p>
                            <Icon icon="tabler:arrow-up" color='white' height={'2rem'} />
                        </span>
                        <span onClick={() => window.location.href = props.github} className='cursor-pointer header_list h-max w-max flex flex-row items-center gap-2 bg-slate-800 text-white p-2 rounded'>
                            <p>GitHub</p>
